...
<div class="container" style="margin-top: 80px;">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form method="post" style="margin-bottom: 40px;" class="modifyImage" enctype="multipart/form-data">
                <label class="label col-md-3 control-label">Titre</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" name="titre" value="${image.titre}">
                </div>
                <label class="label col-md-3 control-label">Type</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" name="type"  value="${image.photoType}">
                </div>
                <label class="label col-md-3 control-label">Description</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" name="desc"  value="${image.description}">
                </div>
                <label class="label col-md-3 control-label">Mots-clés</label>
                <div class="col-md-9">
                    <input type="text" name="motscles" class="form-control"  value="${image.motscles}">
                </div>
...
<script src="${pageContext.request.contextPath}/js/modifyImage.js"></script>
</html>
